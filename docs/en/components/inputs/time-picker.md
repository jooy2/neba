...
- Each column is one tab stop, on its chosen row or its first. ↑ and ↓ move within the column and Home and End jump to its ends; Enter, Space or a press chooses the row.
