...
- portal은 요소를 DOM의 다른 곳으로 옮기고 스크린 리더는 DOM 순서대로 읽으므로, portal된 내용은 쓴 자리가 아니라 옮겨진 자리에서 읽힙니다. 무언가와 **함께** 속하는 내용이라면 `aria-controls` · `aria-describedby`나 focus 이동으로 그렇다고 말해야 합니다.
