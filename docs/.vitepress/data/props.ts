...
export const propTables: Record<string, PropRow[]> = {
  ...
  MenuSubmenu: [
    ...
    },
    {
      ...
      shared: true,
      description: {
        ko: '부모 행의 어느 쪽으로 열릴지. 생략하면 행의 inline 끝 쪽, 즉 오른쪽이고 RTL에서는 왼쪽입니다',
        en: "Which edge of the parent row it opens against. Left out, the row's inline end: the right, or the left under RTL"
      }
    },
    {
      name: 'sideOffset',
  ...
  AnimateMarquee: [
    ...
    },
    {
      ...
      default: 'true',
      description: {
        ko: '포인터가 올라가 있거나 안쪽에 focus가 있는 동안 멈춥니다. 지나가는 내용은 클릭할 수 없기 때문입니다. trigger="hover"에서는 그 둘이 띠를 움직이게 하므로 적용되지 않습니다',
