 ...
 *
 *   src/standalone.css  --(Tailwind)-->  dist/styles.css     `neba/styles.css`
 *   src/styles.css      --(copy)------>  dist/tailwind.css   `neba/tailwind.css`
 *
 * The names cross over, and deliberately so. `neba/styles.css` is the one line
 ...
 * — the same line that, in the copied file, means `node_modules/neba/dist/` for
 * a consumer who does run Tailwind. One declaration serves both outputs.
 */
