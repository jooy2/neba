 ...
 * take the surrounding paragraph's, which is the size the box deliberately is
 * not.
 */
const glyphFontClasses: Record<NebaSize, string> = {
  xs: 'text-[0.875rem]',
  sm: 'text-[1rem]',
  md: 'text-[1.25rem]',
  lg: 'text-[1.5rem]',
...
export const Icon = React.forwardRef<HTMLSpanElement, IconProps>(function Icon(
  ...
  const classNames = [
    ...
    // box itself would be a no-op; what makes an em-sized drawing work is the
    // box being an em, which `size-*` and this pair together arrange.
