 ...
 */
export const TooltipProvider = BaseUITooltip.Provider;
 ...
 * The plate.
 *
 * `solid` and `secondary` by default rather than the frosted panel the popups
 * elsewhere use: a tooltip is read in the half-second it is up, over whatever
 * happens to be behind it, and a translucent sheet is the one surface in the
 * library that cannot promise contrast. So this one is filled.
 *
      ...
      <BaseUITooltip.Portal>
        ...
        >
          ...
          >
            {arrow ? (
              <BaseUITooltip.Arrow
                // Base UI positions the arrow and reports which side it ended
              ...
              >
                <svg
                  ...
                  className="block"
                >
                  <path d="M0 0h10L5 5z" fill="var(--n-fill)" />
                </svg>
              </BaseUITooltip.Arrow>
            ) : null}
            {content}
