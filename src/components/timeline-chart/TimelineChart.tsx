 ...
 */
function packRow(row: NebaTimelineSeries): { spans: Placed[]; lanes: number } {
 ...
 * this differs from a BarChart and is not an omission: `barPath` rounds the
