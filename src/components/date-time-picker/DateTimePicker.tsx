...
export const DateTimePicker = React.forwardRef<HTMLButtonElement, DateTimePickerProps>(
  function DateTimePicker(
     ...
     * span test TimePicker makes, moved onto the absolute timeline so that the
    ...
    const nowValue = withTime(nowMoment, {
      seconds: showSeconds ? nowMoment.getSeconds() : 0
    });
    const nowBlocked =
        ...
        <div className="flex flex-col gap-1.5">
          <div className={cx('flex items-stretch', gapClasses[size])}>
            ...
            <TimeGrid
              ...
              // With no day chosen yet the clock writes onto today, and picking
              // a day afterwards keeps whatever time was set.
