...
export const fr: NebaLocale = {
  ...
  image: { unavailable: 'Image indisponible', preview: 'Agrandir l’image' },
  chart: {
    label: 'Graphique',
    size: 'Taille',
    title: 'Libellé',
  ...
  window: {
    ...
    resizeHint: 'Utilisez les touches fléchées pour redimensionner la fenêtre'
  },
  layout: {
  ...
  otp: {
    slot: 'Caractère {index} sur {total}'
  },
  file: {
  ...
  prompt: {
    send: 'Envoyer',
    stop: 'Arrêter',
    drop: 'Déposez des fichiers ici pour les joindre'
  }
};
