...
export const de: NebaLocale = {
  ...
  image: { unavailable: 'Bild nicht verfügbar', preview: 'Bild vergrößern' },
  chart: {
    label: 'Diagramm',
    size: 'Größe',
    title: 'Bezeichnung',
  ...
  window: {
    ...
    resizeHint: 'Mit den Pfeiltasten die Fenstergröße ändern'
  },
  layout: {
  ...
  approval: {
    request: 'Berechtigung erforderlich',
  ...
  reasoning: {
    thinking: 'Denkt nach …',
    thought: '{duration} nachgedacht',
    done: 'Nachdenken beendet'
  },
  context: {
    label: 'Kontext',
    input: 'Eingabe',
