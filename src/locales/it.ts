...
export const it: NebaLocale = {
  ...
  carousel: {
    ...
    play: 'Riproduci la presentazione'
  },
  picker: {
  ...
  image: { unavailable: 'Immagine non disponibile', preview: 'Ingrandisci immagine' },
  chart: {
    label: 'Grafico',
    size: 'Dimensione',
    title: 'Etichetta',
  ...
  window: {
    ...
    resizeHint: 'Usa i tasti freccia per ridimensionare la finestra'
  },
  layout: {
  ...
  otp: {
    slot: 'Carattere {index} di {total}'
  },
  file: {
    title: 'Trascina qui i file o fai clic per sfogliare',
    remove: 'Rimuovi {name}'
  },
  timeline: {
    complete: 'Completato',
  ...
  prompt: {
    send: 'Invia',
    stop: 'Interrompi',
    drop: 'Trascina qui i file per allegarli'
  }
};
