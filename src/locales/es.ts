...
export const es: NebaLocale = {
  ...
  gallery: {
    label: 'Galería',
    item: 'Imagen {index} de {total}',
    previous: 'Imagen anterior',
    next: 'Imagen siguiente'
  },
  image: { unavailable: 'Imagen no disponible', preview: 'Ampliar imagen' },
  chart: {
    label: 'Gráfico',
    size: 'Tamaño',
    title: 'Etiqueta',
  ...
  file: {
    title: 'Suelta los archivos aquí o haz clic para buscarlos',
    remove: 'Quitar {name}'
  },
  timeline: {
    complete: 'Completado',
  ...
  reasoning: {
    thinking: 'Pensando…',
    thought: 'Ha pensado durante {duration}',
    done: 'Ha terminado de pensar'
  },
  context: {
    label: 'Contexto',
    input: 'Entrada',
  ...
  prompt: {
    send: 'Enviar',
    stop: 'Detener',
    drop: 'Suelta archivos aquí para adjuntarlos'
  }
};
