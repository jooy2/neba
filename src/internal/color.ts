...
function hexToRgba(hex: string): ColorValue | null {
 ...
 */
export function formatColor(hsv: Hsv, alpha: number, format: ColorFormat): string {
...
export function cssColor(hsv: Hsv, alpha = 1): string {
...
export const checkerBackground = {
  backgroundImage:
    'linear-gradient(45deg, var(--neba-border) 25%, transparent 25%), linear-gradient(-45deg, var(--neba-border) 25%, transparent 25%), linear-gradient(45deg, transparent 75%, var(--neba-border) 75%), linear-gradient(-45deg, transparent 75%, var(--neba-border) 75%)',
