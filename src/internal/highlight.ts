 ...
 * and ninety languages — the fixed-cost trap `i18n.ts` documents, in a
 * different shape. An explicit map is thirty-four chunks, of which a page
 ...
 * Anything else is `registerLanguage`, below.
 */
 ...
 */
export function tokenize(html: string): CodeLine[] {
